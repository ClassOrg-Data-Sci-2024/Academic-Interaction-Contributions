...
During the exploration of the data, it was noticed that the file `mtg999st015` is an outlier for this dataset as it is a transcript of a forum for international educators that had exclusively staff participants.
...
Events in the "interview" category will also be omitted from analysis as they are also outliers in the data set due to their sociolinguistic interview nature.
