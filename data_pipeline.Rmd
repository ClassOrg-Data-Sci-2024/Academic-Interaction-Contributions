...
Based on these total counts, exclamations will be removed from the data frame because they represent less than one percent of the total data. These word counts are being used as a quantifiable proxy for a speaker's level of engagement with a speech event, so truncated words, hesitations, and filler words will also be removed but backchannel cues will be retained.
